...
- **Tracker** → file findings via `TRACKER.md` (user-level files under `~/.kru/management/<project-slug>/`) when the lead asks for tickets; otherwise return the audit inline.
