...
Every seat carries `## Design for what they'll actually do` — the principle, in one paragraph. This skill holds what it resolves to per domain: the actor each domain forgets, the trap that actor sets, and the literature behind it.
